      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h1 className="text-3xl font-bold text-red-600">
              <span className="text-4xl">ひらがな</span> Flashcards
            </h1>
            <p className="text-gray-600">Master Japanese characters through spaced repetition</p>
          </div>
        ...
        <div className="flex flex-wrap gap-4 mb-6">
          ...
          <div className="px-4 py-2 bg-blue-50 rounded-lg">
            ...
            <div className="text-xl font-bold text-blue-600">{sessionStats.streak}</div>
          </div>
          {studyMode === 'quiz' && (
            <div className="px-4 py-2 bg-purple-50 rounded-lg">
              <div className="text-sm text-gray-600">Time</div>
              <div className="text-xl font-bold text-purple-600">{timeSpent}s</div>
            </div>
          )}
        </div>
      </div>
      ...
      {showStats ? (
        <div className="bg-white rounded-2xl shadow-lg p-8 text-center">
          ...
          <div className="space-y-3 max-w-md mx-auto">
            <button
              onClick={resetSession}
              className="w-full p-4 bg-red-600 text-white rounded-xl hover:bg-red-700 transition"
            >
              Practice Again
            </button>
            <button
        ...
        <div className="relative">
          ...
          >
            ...
            {/* Back of card */}
            <div className={`absolute inset-0 bg-gradient-to-br from-red-50 to-white rounded-2xl shadow-xl p-8 flex flex-col items-center justify-center transition-opacity duration-500 ${
              isFlipped ? 'opacity-100' : 'opacity-0'
            }`}>
              <div className="text-6xl font-bold mb-4">{currentCard?.symbol}</div>
              <div className="text-4xl font-mono text-red-600 mb-6">{currentCard?.romaji}</div>
